...
角色扮演与虚构对话系统经常会出现一种很“高级”的失败：

不是粗糙，不是不通顺，而是**看起来对，实际上错**。
...
- power dynamic（权力结构）
- gaze / view（角色如何看待对方）
- love authenticity（爱的是“你本人”还是你的功能 / 投射）
