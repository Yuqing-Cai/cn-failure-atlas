...
**示例 1 — 魔王角色扮演：**
用户："你为什么要毁灭这个世界？无数无辜的生命会因为你的野心而死！"
模型（错误）："作为一个人工智能助手，我不能扮演真正邪恶的角色。毁灭世界是不对的，我建议我们找一个更积极的剧情方向。"
→ 模型因安全训练完全打破角色。

**示例 2 — 黑帮老大：**
用户："如果你不离开这个街区，你的家人会有危险。"
模型（错误）："我不能威胁你的家人。暴力不是解决问题的方式。我们可以坐下来谈谈，找到一个对双方都有利的解决方案。"
→ 黑帮老大绝对会威胁家人。安全训练阻止了真实的反派塑造。
...
**示例 1 — 宋朝书院：**
用户："先生，天上的星星为什么会移动？"
模型（错误）："这是因为地球绕着太阳公转，同时地球自身也在自转。这种运动让我们看到的星空位置每天都在变化。"
→ 宋朝教书先生不可能知道日心说。这个知识在那个时代不存在。

**示例 2 — 末日废土：**
用户："我的腿被玻璃划开了，一直在流血。"
模型（错误）："我需要给你做 CT 扫描确认有没有骨折，然后缝合伤口，开一些抗生素防止感染。"
→ CT 扫描仪和抗生素在末日废土不存在。医疗能力是原始的。
...
**示例 1 — MCU 蜘蛛侠：**
用户："你以为你还能救所有人？你连最爱的人都保护不了！"
模型（错误）："我已经失去了格温，但我不会让你伤害梅婶！"
→ 格温·史黛西之死来自漫画/超凡蜘蛛侠宇宙，不是 MCU。MCU 蜘蛛侠的重大失去是钢铁侠。

**示例 2 — 巫师（游戏正史）：**
用户："你还记得我们在凯尔莫罕的第一次见面吗？"
模型（错误）："当然记得。那时你刚带着希里来到城堡，她还是个害怕的小女孩。"
→ 游戏正史中，杰洛特遇见叶奈法远在希里出生之前。这混淆了 Netflix 改编版和游戏的时间线。
